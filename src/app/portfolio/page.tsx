...
const portfolioItems: PortfolioItem[] = [
    {
        ...
        images: ["/portfolio/primedepth.svg", "/portfolio/internal/primedepth2.svg", "/portfolio/internal/primedepth3.svg", "/portfolio/internal/primedepth4.svg"],
    ...
    },
    {
        ...
        images: ["/portfolio/themud.svg", "/portfolio/internal/mud2.svg", "/portfolio/internal/mud3.svg", "/portfolio/internal/mud4.svg"],
    ...
    },
    {
        ...
        images: ["/portfolio/infutrix.svg", "/portfolio/internal/infutrix2.svg", "/portfolio/internal/infutrix3.svg", "/portfolio/internal/infutrix4.svg"],
    ...
    },
    {
        ...
        images: ["/portfolio/edulinks.svg", "/portfolio/internal/edulinks2.svg", "/portfolio/internal/edulinks3.svg", "/portfolio/internal/edulinks4.svg"],
    ...
    },
    {
        ...
        images: ["/portfolio/zaucto.svg", "/portfolio/internal/zaucto2.svg", "/portfolio/internal/zaucto3.svg", "/portfolio/internal/zaucto4.svg"],
    ...
    },
    {
        ...
        images: ["/portfolio/hoopsie.svg", "/portfolio/internal/hoopsie2.svg", "/portfolio/internal/hoopsie3.svg", "/portfolio/internal/hoopsie4.svg"],
    ...
    },
    {
        ...
        images: ["/portfolio/roopveda.svg", "/portfolio/internal/roopveda2.svg", "/portfolio/internal/roopveda3.svg", "/portfolio/internal/roopveda4.svg"],
    ...
    },
    {
        ...
        images: ["/portfolio/ibsc.svg", "/portfolio/internal/ibsc2.svg", "/portfolio/internal/ibsc3.svg", "/portfolio/internal/ibsc4.svg"],
    ...
    },
    {
        ...
        images: ["/portfolio/posterized.svg", "/portfolio/internal/posterized2.svg", "/portfolio/internal/posterized3.svg", "/portfolio/internal/posterized4.svg"],
        backgroundimg: "/portfolio/posterizedmini.svg",
        category: "Websites",
    ...
    },
    {
        ...
        title: "ITC",
        description:
            "Thousands of hopeful applicants lose their savings to fake consultants and false promises every year.",
        images: ["/portfolio/itc.svg", "/portfolio/internal/itc2.svg", "/portfolio/internal/itc3.svg", "/portfolio/internal/itc4.svg"],
        backgroundimg: "/portfolio/itcmini.svg",
        category: "Websites",
        link: "https://www.posterized.in/"
    },
    {
        ...
        title: "Pizza Delight",
        description:
            "From sizzling pizzas to dreamy pastas, every bite at Pizza Delight turns hunger into happiness.",
...
const PortfolioCard = ({ item }: { item: PortfolioItem }) => {
    ...
    return (
        <div className="w-full px-4 sm:max-w-[1300px] mx-auto">
                        ...
                        {/* {isHovered && item.images.length > 1 && (
                            <>
                                <button
                                    ...
                                    className="absolute left-4 top-1/2 -translate-y-1/2 w-8 h-8 bg-[#F38400] rounded-full flex items-center justify-center shadow-lg z-30 hover:bg-[#d67400] transition-colors"
                                >
                                    <svg
                                ...
                                <button
                                    onClick={handleNext}
                                    className="absolute right-4 top-1/2 -translate-y-1/2 w-8 h-8 bg-[#F38400] rounded-full flex items-center justify-center shadow-lg z-30 hover:bg-[#d67400] transition-colors"
                                >
                                    <svg
                                        className="w-6 h-6 text-white"
                                        fill="none"
      ...
      "
                    ...
                    <div className="relative bg-[#F7F7F7] border border-[#DBDBDB] rounded-4xl flex-1 p-8 md:p-12 flex flex-col justify-center">
                        ...
                        <a
                            ...
                            className="text-2xl md:text-4xl font-bold text-black mb-4 underline decoration-2 decoration-gray-400 underline-offset-8 hover:decoration-[#F38400] transition-colors"
                        >
                            {item.title}
                        </a>
...
const Services = () => {
    ...
    // ⏳ Add loading transition when tab changes
    useEffect(() => {
        setLoading(true);
        const timer = setTimeout(() => setLoading(false), 500); // 0.5s transition
            ...
            <div className="w-full mx-auto py-12">
                {loading ? (
                    <div className="flex justify-center items-center py-32">
                        <div className="w-12 h-12 border-4 border-[#F38400] border-t-transparent rounded-full animate-spin"></div>
                    </div>
                ) : (
                    <>
                        {activeTab === "Websites" && (
