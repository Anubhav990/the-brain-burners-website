        ...
        <div className="relative overflow-hidden text-xl md:text-4xl font-medium leading-[50px]">
          ...
          <div className="text-[25px] md:text-[54px] text-[#F38400] space-y-3 leading-[30px] md:leading-[63px]">
            <p className="capitalize">
              Artificial Intelligence isn’t the<br /> future it’s the now. We help<br /> businesses modernize with AI,<br /> making systems smarter, faster,<br /> and more efficient to stay ahead in<br /> a competitive world.
            </p>
          </div>
      ...
      <div ref={mobileRef} className="relative z-20 text-left sm:hidden block">
        <div className="relative overflow-hidden text-xl font-medium leading-[38px]">
          ...
          <div className="text-[25px] text-[#F38400] leading-[38px]">
            <p className="capitalize">
              Artificial Intelligence isn’t the future it’s the now. We help businesses modernize with AI, making systems smarter, faster, and more efficient to stay ahead in a competitive world.
            </p>
          </div>
