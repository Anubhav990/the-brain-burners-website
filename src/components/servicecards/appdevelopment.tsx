...
export default function AppDevServiceCards() {
    return (
        <section className="max-w-6xl mx-auto px-4 py-12 mt-0 sm:mt-10">
            ...
            <div className="hidden md:flex flex-col gap-4">
                ...
                <div className="flex justify-center gap-4">
                    ...
                    >
                        <div className="p-6">
                            ...
                            <p className="text-black leading-relaxed">
                                We create applications tailored to your business needs, not one-size-fits-all.
                            </p>
                        </div>
                        <div className="w-180 mt-6 flex justify-center md:justify-end">
                            <Image
                                src="/services/appdevelopment/custombuilt.svg"
                                alt="User-Centered"
                                width={200}
                                height={200}
                    ...
                    >
                        <div className="w-180 mt-6 flex justify-center md:justify-end">
                            <Image
                                src="/services/appdevelopment/scalable.svg"
                                alt="Wireframes"
                                width={200}
                                height={200}
                                className="w-full h-full object-contain"
                        ...
                        <div className="p-6">
                            ...
                            <p className="text-black leading-relaxed text-right">
                                Apps designed to grow with you, handling today and tomorrow with ease.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex justify-center gap-4 mt-4">
                    ...
                    >
                        <div className="p-6">
                            ...
                            <p className="text-black leading-relaxed">
                                Intuitive, simple, and user-friendly because the best apps just work.
                            </p>
                        </div>
                        <div className="w-180 mt-6 flex justify-center md:justify-end">
                            <Image
                                src="/services/appdevelopment/smooth.svg"
                    ...
                    >
                        <div className="w-180 mt-6 flex justify-center md:justify-end">
                            <Image
                                src="/services/appdevelopment/designsystems.svg"
                        ...
                        <div className="p-6">
                            ...
                            <p className="text-black leading-relaxed text-right">
                                From strategy to post-launch, we stay with you at every stage of the journey.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div className="flex flex-col gap-4 sm:hidden">
                ...
                <div className="rounded-2xl p-6 bg-[#FFD39D] flex flex-col items-start text-left">
                    <h3 className="text-xl text-black font-semibold mb-2">Custom-Built Solutions</h3>
                ...
                <div className="rounded-2xl p-6 bg-[#FFF3E4] flex flex-col items-start text-left">
                    <h3 className="text-xl font-semibold mb-2 text-black">Smooth User Experience</h3>
                    <p className="text-black mb-0 sm:mb-4">
                        Intuitive, simple, and user-friendly because the best apps just work.
                    </p>
                    <Image
