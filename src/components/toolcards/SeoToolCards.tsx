...
const tools = [
  ...
  { name: "Google search console", img: "/services/seo/googlesearchconsole.svg", gif: "/services/watereffect/watereffect3.gif" },
  { name: "screming frog", img: "/services/seo/screamingfrog.svg", gif: "/services/watereffect/watereffect4.gif" },
  { name: "html", img: "/services/webdevelopment/html.svg", gif: "/services/watereffect/watereffect2.gif" },
];

export default function SeoToolsCards() {
  return (
