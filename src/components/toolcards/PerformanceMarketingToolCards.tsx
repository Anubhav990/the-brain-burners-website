...
const tools = [
  { name: "Mailchimp", img: "/services/performance-marketing/mailchimp.svg", gif: "/services/watereffect/watereffect1.gif" },
  { name: "Ahrefs", img: "/services/performance-marketing/achrefs.svg", gif: "/services/watereffect/watereffect2.gif" },
  { name: "Google Ads", img: "/services/performance-marketing/googleads.svg", gif: "/services/watereffect/watereffect3.gif" },
  { name: "Facebook Ads ", img: "/services/performance-marketing/facebookads.svg", gif: "/services/watereffect/watereffect4.gif" },
  { name: "Hubspot", img: "/services/performance-marketing/hubspot.svg", gif: "/services/watereffect/watereffect5.gif" },
];

export default function PerformanceMarketingToolsCards() {
  return (
