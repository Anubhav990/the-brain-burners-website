...
const tools = [
  { name: "chatgpt", img: "/services/ai/chatgpt.svg", gif: "/services/watereffect/watereffect1.gif" },
  { name: "Copilot", img: "/services/ai/copilot.svg", gif: "/services/watereffect/watereffect2.gif" },
  { name: "claude", img: "/services/ai/claude.svg", gif: "/services/watereffect/watereffect3.gif" },
  { name: "Gemini", img: "/services/ai/gemini.svg", gif: "/services/watereffect/watereffect4.gif" },
  { name: "Notion AI", img: "/services/ai/notion.svg", gif: "/services/watereffect/watereffect4.gif" },
];

export default function AIToolsCards() {
  return (
