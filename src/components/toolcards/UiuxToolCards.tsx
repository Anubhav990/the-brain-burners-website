...
const tools = [
  { name: "Figma", img: "/services/uiux/figma.svg", gif: "/services/watereffect/watereffect1.gif" },
  { name: "Photoshop", img: "/services/uiux/photoshop.svg", gif: "/services/watereffect/watereffect2.gif" },
  { name: "Adobe Illustrator", img: "/services/uiux/adobe.svg", gif: "/watereffect/uiux/watereffect3.gif" },
  { name: "Sketch", img: "/services/uiux/sketch.svg", gif: "/services/watereffect/watereffect4.gif" },
  { name: "Adobe XD", img: "/services/uiux/xd.svg", gif: "/services/watereffect/watereffect5.gif" },
];

export default function UiUxToolsCards() {
  return (
